ko.dependentObservable = function (evaluatorFunctionOrOptions, evaluatorFunctionTarget, options) {
    ...
    dependentObservable.hasDependency = function(obj) {
        return ko.utils.arrayFirst(_subscriptionsToDependencies, function(item) {return item.target === obj;}) !== null;
    };
    ...
    ko.exportProperty(dependentObservable, 'hasDependency', dependentObservable.hasDependency);
    dependentObservable._latestValue = _latestValue;
