var templatingBehaviors =
    function (testConfiguration) {
        ...
        describe('Templating ' + (myConfiguration ? myConfiguration.name : "default provider settings"), {
            ...
            'Should be able to render a template using data-bind syntax': function () {
                ...
                testNode.innerHTML = "<div " + bindingAttribute + "='template:\"someTemplate\"'></div>";
            ...
            'Should be able to tell data-bind syntax which object to pass as data for the template (otherwise, uses viewModel)': function () {
                ...
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"someTemplate\", data: someProp }'></div>";
            ...
            'Should be able to pick template as a function of the data item using data-bind syntax': function () {
                ...
                ko.setTemplateEngine(new dummyTemplateEngine({ someTemplate: "result = [js: childProp]" }));
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: templateSelectorFunction, data: someProp }'></div>";
            ...
            'Should be able to chain templates, rendering one from inside another': function () {
                ko.setTemplateEngine(new dummyTemplateEngine({
                    ...
                    innerTemplate: "inner template output <span " + bindingAttribute + "='text: 123'></span>"
                }));
                testNode.innerHTML = "<div " + bindingAttribute + "='template:\"outerTemplate\"'></div>";
                ko.applyBindings(null, testNode);
            ...
            'Should stop tracking inner observables referenced by a chained template as soon as the chained template output node is removed from the document': function () {
                ...
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"outerTemplate\", data: someProp }'></div>";
                ko.applyBindings({ someProp: { childProp: innerObservable} }, testNode);
            ...
            'Should handle data-bind attributes from inside templates, regardless of element and attribute casing': function () {
                ko.setTemplateEngine(new dummyTemplateEngine({ someTemplate: "<INPUT " + bindingAttribute + "='value:\"Hi\"' />" }));
                ko.renderTemplate("someTemplate", null, null, testNode);
            ...
            'Should handle data-bind attributes that include newlines from inside templates': function () {
                ko.setTemplateEngine(new dummyTemplateEngine({ someTemplate: "<input " + bindingAttribute + "='value:\n\"Hi\"' />" }));
                ko.renderTemplate("someTemplate", null, null, testNode);
                value_of(testNode.childNodes[0].childNodes[0].value).should_be("Hi");
            },

            'Data binding syntax should be able to reference variables put into scope by the template engine': function () {
                ko.setTemplateEngine(new dummyTemplateEngine({ someTemplate: "<input " + bindingAttribute + "='value:message' />" }));
            ...
            'Data binding syntax should defer evaluation of variables until the end of template rendering (so bindings can take independent subscriptions to them)': function () {
                ko.setTemplateEngine(new dummyTemplateEngine({
                    someTemplate: "<input " + bindingAttribute + "='value:message' />[js: message = 'goodbye'; undefined; ]"
                }));
                ko.renderTemplate("someTemplate", null, { templateRenderingVariablesInScope: { message: "hello"} }, testNode);
            ...
            'Data binding syntax should use the template\'s \'data\' object as the viewModel value (so \'this\' is set correctly when calling click handlers etc.)': function () {
                ko.setTemplateEngine(new dummyTemplateEngine({
                    someTemplate: "<button " + bindingAttribute + "='click: someFunctionOnModel'>click me</button>"
                }));
                var viewModel = {
            ...
            'Data binding syntax should permit nested templates, and only bind inner templates once': function () {
                ...
                ko.bindingProvider.instance = {
                    ...
                    configuration : originalBindingProvider.configuration  //???!!!
                };
                
                ko.setTemplateEngine(new dummyTemplateEngine({
                    outerTemplate: "Outer <div " + ko.bindingProvider.configuration(originalBindingProvider).bindingAttribute + "='template: { name: \"innerTemplate\", bypassDomNodeWrap: true }'></div>",
                    innerTemplate: "Inner via inline binding: <span " + ko.bindingProvider.configuration(originalBindingProvider).bindingAttribute + "='text: ++numBindings'></span>"
                    + "Inner via external binding: <em></em>"
                }));
                var model = { numBindings: 0 };
                testNode.innerHTML = "<div " + ko.bindingProvider.configuration(originalBindingProvider).bindingAttribute + "='template: { name: \"outerTemplate\", bypassDomNodeWrap: true }'></div>";
            ...
            'Data binding syntax should support \'foreach\' option, whereby it renders for each item in an array but doesn\'t rerender everything if you push or splice': function () {
                ...
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"itemTemplate\", foreach: myCollection }'></div>";
            ...
            'Data binding \'foreach\' option should apply bindings within the context of each item in the array': function () {
                var myArray = new ko.observableArray([{ personName: "Bob" }, { personName: "Frank"}]);
                ko.setTemplateEngine(new dummyTemplateEngine({ itemTemplate: "The item is <span " + bindingAttribute + "='text: personName'></span>" }));
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"itemTemplate\", foreach: myCollection }'></div>";
            ...
            'Data binding \'foreach\' options should only bind each group of output nodes once': function () {
                ...
                ko.setTemplateEngine(new dummyTemplateEngine({ itemTemplate: "<span " + bindingAttribute + "='countInits: true'></span>" }));
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"itemTemplate\", foreach: myCollection }'></div>";
            ...
            'Data binding \'foreach\' option should accept array with "undefined" and "null" items': function () {
                ...
                ko.setTemplateEngine(new dummyTemplateEngine({ itemTemplate: "The item is <span " + bindingAttribute + "='text: String($data)'></span>" }));
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"itemTemplate\", foreach: myCollection }'></div>";
            ...
            'Data binding syntax should include any items whose \'_destroy\' flag is set if you use includeDestroyed': function () {
                ...
                ko.setTemplateEngine(new dummyTemplateEngine({ itemTemplate: "someProp=[js: someProp]" }));
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"itemTemplate\", foreach: myCollection, includeDestroyed: true }'></div>";
            ...
            'Data binding syntax should support \"if\" condition': function () {
                ...
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"myTemplate\", \"if\": myProp }'></div>";
            ...
            'Data binding syntax should support \"ifnot\" condition': function () {
                ...
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"myTemplate\", ifnot: shouldHide }'></div>";
            ...
            'Data binding syntax should support \"if\" condition in conjunction with foreach': function () {
                ko.setTemplateEngine(new dummyTemplateEngine({ myTemplate: "Value: [js: myProp().childProp]" }));
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"myTemplate\", \"if\": myProp, foreach: [$data, $data, $data] }'></div>";
            ...
            'Should be able to populate checkboxes from inside templates, despite IE6 limitations': function () {
                ko.setTemplateEngine(new dummyTemplateEngine({ someTemplate: "<input type='checkbox' " + bindingAttribute + "='checked:isChecked' />" }));
            ...
            'Should be able to populate radio buttons from inside templates, despite IE6 limitations': function () {
                ko.setTemplateEngine(new dummyTemplateEngine({ someTemplate: "<input type='radio' name='somename' value='abc' " + bindingAttribute + "='checked:someValue' />" }));
            ...
            'Should be able to render a different template for each array entry by passing a function as template name': function () {
                ...
                testNode.innerHTML = "<div " + bindingAttribute + "='template: {name: getTemplateModelProperty, foreach: myCollection}'></div>";
            ...
            'Data binding \'templateOptions\' should be passed to template': function () {
                ...
                testNode.innerHTML = "<div " + bindingAttribute + "='template: {name: \"myTemplate\", foreach: people, templateOptions: someAdditionalData }'></div>";
            ...
            'If the template binding is updated, should dispose any template subscriptions previously associated with the element': function () {
                ...
                testNode.innerHTML = "<div " + bindingAttribute + "='template: \"myTemplate\", unrelatedBindingHandler: unrelatedObservable()'></div>";
                ko.applyBindings(myModel, testNode);
            ...
            'Should be able to specify a template engine instance using data-bind syntax': function () {
                ...
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"theTemplate\", templateEngine: chosenEngine }'></div>";
            ...
            'Data-bind syntax should expose parent binding context as $parent if binding with an explicit \"data\" value': function () {
                ko.setTemplateEngine(new dummyTemplateEngine({
                    myTemplate: "ValueLiteral: [js:$parent.parentProp], ValueBound: <span " + bindingAttribute + "='text: $parent.parentProp'></span>"
                }));
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"myTemplate\", data: someItem }'></div>";
            ...
            'Data-bind syntax should expose all ancestor binding contexts as $parents': function () {
                ko.setTemplateEngine(new dummyTemplateEngine({
                    outerTemplate: "<div " + bindingAttribute + "='template: { name:\"middleTemplate\", data: middleItem }'></div>",
                    middleTemplate: "<div " + bindingAttribute + "='template: { name: \"innerTemplate\", data: innerItem }'></div>",
                ...
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"outerTemplate\", data: outerItem }'></div>";
            ...
            'Should not be allowed to rewrite templates that embed anonymous templates': function () {
                ...
                //
                // <div " + bindingAttribute + "="foreach: someArray">
                ...
                ko.setTemplateEngine(new dummyTemplateEngine({
                    myTemplate: "<div " + bindingAttribute + "='template: { data: someData }'>Childprop: [js: childProp]</div>"
                }));
                testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"myTemplate\" }'></div>";
            ...
            'Should not be allowed to rewrite templates that embed control flow bindings': function () {
                ...
                ko.utils.arrayForEach(['if', 'ifnot', 'with', 'foreach'], function (bindingName) {
                    ko.setTemplateEngine(new dummyTemplateEngine({ myTemplate: "<div " + bindingAttribute + "='" + bindingName + ": \"SomeValue\"'>Hello</div>" }));
                    testNode.innerHTML = "<div " + bindingAttribute + "='template: { name: \"myTemplate\" }'></div>";
            ...
            'Should be able to render anonymous templates using virtual containers': function () {
                ko.setTemplateEngine(new dummyTemplateEngine());
                testNode.innerHTML = "Start <!-- " + virtualElementTag + " template: { data: someData } -->Childprop: [js: childProp]<!-- /" + virtualElementTag + " --> End";
                ko.applyBindings({ someData: { childProp: 'abc'} }, testNode);
                value_of(testNode).should_contain_html("start <!-- " + virtualElementTag + " template: { data: somedata } --><div>childprop: abc</div><!-- /" + virtualElementTag + " -->end");
            },
            ...
            'Should be able to use anonymous templates that contain first-child comment nodes': function () {
                ...
                ko.setTemplateEngine(new dummyTemplateEngine({}));
                testNode.innerHTML = "start <div " + bindingAttribute + "='foreach: [1,2]'><span><!-- leading comment -->hello</span></div>";
                ko.applyBindings(null, testNode);
                value_of(testNode).should_contain_html('start <div ' + bindingAttribute + '="foreach: [1,2]"><span><!-- leading comment -->hello</span><span><!-- leading comment -->hello</span></div>');
            },
            ...
            'Should allow anonymous templates output to include top-level virtual elements, and will bind their virtual children only once': function () {
                ...
                var initCalls = 0;
                ko.bindingHandlers.countInits = { init: function () { initCalls++ } };
                testNode.innerHTML = "<div " + bindingAttribute + "='template: {}'><!-- " + virtualElementTag + " nonexistentHandler: true --><span " + bindingAttribute + "='countInits: true'></span><!-- /" + virtualElementTag + " --></div>";
                ko.applyBindings(null, testNode);
    ...
    templatingBehaviors();
    templatingBehaviors({ name: "alternative configuration", virtualElementTag: "ko1", bindingAttribute: "data-bind1" });
