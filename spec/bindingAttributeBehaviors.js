var bindingAttributeBehaviors =

function (testConfiguration) {
    var existingBindingProvider = ko.bindingProvider.instance;
    var myConfiguration = testConfiguration;
    
    describe('Binding attribute syntax ' + (myConfiguration ? myConfiguration.name : "default provider settings"), {
...
bindingAttributeBehaviors({ name: "alternativeConfiguration", virtualElementTag: "ko1", bindingAttribute: "data-bind1" });
