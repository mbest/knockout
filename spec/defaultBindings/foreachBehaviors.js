describe('Binding: Foreach', function() {
    ...
    it('Should move all nodes corresponding to a moved array item, even if they were generated via containerless templates', function() {
        ...
        ko.applyBindings({ someitems: someitems }, testNode);
        expect(testNode).toContainText('123');

        // Now move items, and check the corresponding child nodes are correct
        someitems([3,2,1]);
        expect(testNode).toContainText('321');
    });
    ...
    it('Should be able to give an alias to $data using inline syntax', function() {
    ...
    it('Should add and bind only changed items in a nested observable array', function() {
