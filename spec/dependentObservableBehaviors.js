...
describe('Dependent Observable', function() {
    ...
    it('ko.utils.possiblyWrap should return value if there are no dependencies', function() {
        var nonObservable = 1,
            depedentObservable = ko.utils.possiblyWrap(function () { return nonObservable + 1; });
        expect(ko.isComputed(depedentObservable)).toEqual(false);
        expect(depedentObservable).toEqual(2);
    ...
    it('ko.utils.possiblyWrap should return computed object if there are dependencies', function() {
        var observable = ko.observable(1),
            depedentObservable = ko.utils.possiblyWrap(function () { return observable() + 1; });
        expect(ko.isComputed(depedentObservable)).toEqual(true);
        expect(depedentObservable()).toEqual(2);
    ...
    it('Should be able to re-evaluate a computed that previously threw an exception', function() {
        ...
        // The value of the computed is now undefined
